...
List<WorldTime> locationsAfrica = [
...
List<WorldTime> locationsAmerica = [
  ...
  WorldTime(
      url: "America/Indiana/Indianapolis", country: "United States of America"),
  ...
  WorldTime(url: "America/Indiana/Vevay", country: "United States of America"),
  ...
  WorldTime(
      url: "America/Kentucky/Louisville", country: "United States of America"),
  ...
  WorldTime(
      url: "America/North_Dakota/Beulah", country: "United States of America"),
...
List<WorldTime> locationsAtlantic = [
...
List<WorldTime> locationsAustralia = [
...
List<WorldTime> locationsEurope = [
...
List<WorldTime> locationsIndian = [
...
List<WorldTime> locationsPacific = [
...
class ChooseLocation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (data['continent']) {
      case "America":
        locations = locationsAmerica;
        break;
      case "Africa":
        locations = locationsAfrica;
        break;
      case "Asia":
        locations = locationsAsia;
        break;
      case "Atlantic":
        locations = locationsAtlantic;
        break;
      case "Australia":
        locations = locationsAustralia;
        break;
      case "Europe":
        locations = locationsEurope;
        break;
      case "Indian":
        locations = locationsIndian;
        break;
      case "Pacific":
        locations = locationsPacific;
        break;
    }
    return Scaffold(
      appBar: AppBar(
        title: Text(data['continent']),
      ),
        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: Card(
              ...
              child: ListTile(
                leading: Image.asset(
                  "assets/images/flags/${locations[index].country.toLowerCase().replaceAll(" ", "-")}.png",
                  scale: 12,
                ),
                title: Text(locations[index].getCity()),
                subtitle: Text(locations[index].country),
                onTap: () async {
                  data = await locations[index].fetchTime();
                  if (data['err'] == null) {
